  ...
  return (
    <div className="container py-16 mb-24 lg:mb-32">
      <h2 className="text-3xl font-semibold sm:text-4xl mb-10">
        {user?.role === "CUSTOMER"
          ? t("bookingsMyBookings")
          : t("bookingsAllBookings")}
      </h2>
          ...
          <table className="w-full text-left text-sm text-neutral-500 dark:text-neutral-400">
            <thead className="bg-neutral-50 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300">
              <tr>
                ...
                <th className="px-6 py-4 font-semibold">{t("bookingsRoom")}</th>
                <th className="px-6 py-4 font-semibold">
                  {t("bookingsDates")}
                </th>
                <th className="px-6 py-4 font-semibold">
            ...
            <tbody className="divide-y divide-neutral-200 dark:divide-neutral-700">
              {bookings.map((booking) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusBadge(booking.status)}`}
                    >
                  ...
                  <td className="px-6 py-4 text-right">
                    ...
                    >
                      <Eye className="w-4 h-4 mr-1" /> {t("bookingsDetails")}
                    </Link>
                  </td>
                </tr>
              ))}
