...
> = () => {
  ...
  const titleParam =
    searchParams.get("title") || "Trang An Boat Tour & Mua Cave";
  ...
  const getExperienceDescription = () => {
    ...
    if (
      ...
      return {
        p1: `Prepare for a spectacular journey with ${titleParam}, a scenic water and boating experience situated in the beautiful area of ${addressParam}. Perfect for nature lovers and adventurers, this rowing boat and water exploration tour starts at just ${formattedPrice} per person.`,
    ...
    if (
      ...
      return {
        p1: `Get ready to explore the great outdoors with ${titleParam}, an immersive hiking and climbing adventure located in ${addressParam}. Challenge yourself and enjoy panoramic views starting at just ${formattedPrice} per person.`,
    ...
    if (
      ...
      return {
        p1: `Ride the waves with ${titleParam}, an exciting surfing and paddleboarding session at the beaches of ${addressParam}. Ideal for all skill levels, this lesson starts at just ${formattedPrice} per person.`,
    ...
    if (
      ...
      return {
        p1: `Revitalize your body and mind with ${titleParam}, a wellness and fitness experience held in the serene settings of ${addressParam}. This guided activity starts at just ${formattedPrice} per person.`,
    ...
    if (
      ...
      return {
        p1: `Indulge in local flavors with ${titleParam}, a culinary and food tasting journey through the local hotspots of ${addressParam}. Taste traditional dishes starting at just ${formattedPrice} per person.`,
    ...
    return {
      p1: `Embark on the spectacular ${titleParam}, a highly-rated ${categoryParam.toLowerCase()} experience based in the scenic region of ${addressParam}. Perfect for adventure seekers and culture enthusiasts, this activity starts at just ${formattedPrice} per person.`,
      ...
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span>
              {format(priceVal, baseCurrency)} x {nights} day
              {nights > 1 ? "s" : ""}
            </span>
