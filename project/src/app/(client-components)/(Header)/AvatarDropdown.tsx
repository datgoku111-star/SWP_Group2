      ...
      <Popover className={`AvatarDropdown relative flex ${className}`}>
        {({ open, close }) => (
          <>
            ...
            >
              <Avatar sizeClass="w-8 h-8 sm:w-9 sm:h-9" userName={user?.full_name} imgUrl={undefined} />
            </Popover.Button>
                ...
                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      <Avatar sizeClass="w-12 h-12" userName={user?.full_name} imgUrl={undefined} />
                    ...
                    >
                      <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M15.6947 13.7H15.7037M15.6947 16.7H15.7037M11.995 13.7H12.004M11.995 16.7H12.004M8.29529 13.7H8.30427M8.29529 16.7H8.30427"
                            stroke="currentColor"
                            strokeWidth="2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium ">{"My Schedule"}</p>
                      </div>
                    </Link>
                    ...
                    <button
                      ...
                      className="flex items-center w-full p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 text-left"
                    >
                      <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                        <svg
                          width="24"
