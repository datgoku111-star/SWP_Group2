...
export default function AdminDashboardPage() {
  ...
  const { stats, monthlySignups, monthlyRevenue, roleDistribution } =
    data || {
      stats: {
        totalUsers: 120,
  ...
  const roleTotal =
    roleDistribution.reduce((sum: number, item: any) => sum + item.value, 0) ||
    1;
                ...
                {roleDistribution.map((entry: any, index: number) => (
                  ...
                  >
                    ...
                    <span className="font-extrabold text-neutral-900 dark:text-white">
                      {Math.round((entry.value / roleTotal) * 100)}%
                    </span>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 p-6 rounded-3xl shadow-sm">
            <div className="border-b border-neutral-100 dark:border-neutral-700 pb-3 mb-6">
              ...
              <p className="text-xs text-neutral-400 mt-1">
                CLV distribution across different periods
              </p>
            </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis
                    ...
                    tickLine={false}
                    axisLine={false}
                    tickFormatter={(value) => format(Number(value || 0))}
                  />
