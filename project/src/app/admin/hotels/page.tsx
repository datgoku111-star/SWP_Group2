...
export default function AdminHotelsRoomsPage() {
  ...
  const handleSaveRoom = async (e: React.FormEvent) => {
    ...
    if (Number(formPrice) < 0) {
      setFormError("Giá phòng không được nhỏ hơn 0.");
      return;
    }
    ...
    try {
      ...
      if (editingRoom) {
        ...
        if (rooms.some((room) => room.id.startsWith("mock-"))) {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-neutral-500 dark:text-neutral-400 mt-1.5 text-sm">
            CRUD phòng khách sạn, đồng bộ hình ảnh qua Supabase Storage và hiển
            thị trực tiếp lên trang chủ.
          </p>
        </div>
              ...
              {loading ? (
                Array.from({ length: 3 }).map((_, idx) => (
                  <tr key={idx} className="animate-pulse">
                    ...
                    <td className="px-6 py-4.5">
                      <div className="h-4 bg-neutral-200 dark:bg-neutral-700 rounded w-20 mx-auto"></div>
                    </td>
                    <td className="px-6 py-4.5">
                      <div className="h-4 bg-neutral-200 dark:bg-neutral-700 rounded w-10 mx-auto"></div>
                    </td>
                    <td className="px-6 py-4.5">
                      <div className="h-6 bg-neutral-200 dark:bg-neutral-700 rounded-full w-16 mx-auto"></div>
                    </td>
                    <td className="px-6 py-4.5">
                ...
                filteredRooms.map((room, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap font-extrabold text-neutral-900 dark:text-white">
                      {format(room.price_per_night, "USD")}
                    ...
                    <td className="px-6 py-4 text-center whitespace-nowrap">
                      <span
                        className={`inline-flex items-center px-2 py-1 rounded-full text-[10px] font-extrabold ${
          ...
          <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl relative animate-scale-up">
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-neutral-700 dark:text-neutral-350">
                    Giá / Đêm (USD) <span className="text-red-500">*</span>
                  </label>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormAvailableRooms(Number(e.target.value))
                    }
                    min={0}
                    required
                  />
              ...
              <div className="space-y-2.5">
                    ...
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      ...
                      <p className="text-xs text-neutral-500 dark:text-neutral-450 font-semibold text-center">
                        {imageFile
                          ...
                          : "Nhấp để tải ảnh lên Supabase Storage"}
                      </p>
                ...
                <div className="space-y-1">
                  <span className="text-[10px] text-neutral-400 dark:text-neutral-500 block text-center uppercase font-bold">
                    Hoặc
                  </span>
