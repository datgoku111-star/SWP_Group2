...
import { CurrencyCode, convertCurrency, isCurrencyCode } from "@/lib/currency";
...
const CheckOutPagePageMain: FC<CheckOutPagePageMainProps> = ({
  ...
  const toVndAmount = (amount: number) => {
    return Math.round(convertCurrency(amount, baseCurrency, "VND"));
  };
  ...
  const handleConfirmAndPay = async () => {
    ...
    try {
      ...
      const pricePerNight = Number(priceParam) || 19;
      const totalAmountInBaseCurrency = pricePerNight * nights;
      const totalAmountVnd = toVndAmount(totalAmountInBaseCurrency);
                  ...
                  <div className="p-5 bg-blue-50/50 dark:bg-neutral-800 rounded-2xl border border-blue-100/30 dark:border-neutral-700 space-y-3">
                    <div className="flex items-center space-x-3 text-neutral-800 dark:text-neutral-200">
                      ...
                      <h4 className="font-semibold text-base">
                        Thanh toán an toàn bằng VietQR (PayOS)
                      </h4>
                    </div>

                    <p className="text-sm text-neutral-600 dark:text-neutral-300 leading-relaxed">
                      Mã chuyển khoản VietQR động 24/7 sẽ được tạo tự động bởi
                      cổng thanh toán PayOS. Bạn chỉ cần mở app ngân hàng quét
                      mã và thanh toán. Phòng của bạn sẽ được xác nhận tự động
              ...
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-2xl rounded-3xl">
                ...
                <div className="mt-4 flex flex-col items-center space-y-4">
                  ...
                  <p className="text-xs text-center text-neutral-500 leading-relaxed px-2">
                    * Vui lòng nhập đúng nội dung chuyển khoản ở trên để hệ
                    thống tự động xác nhận đơn phòng của bạn ngay lập tức.
                  </p>
